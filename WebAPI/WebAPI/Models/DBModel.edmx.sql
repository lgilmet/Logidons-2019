...
-- --------------------------------------------------
-- Date Created: 09/19/2019 15:48:51
-- Generated from EDMX file: C:\Users\Admin\ProjetsGit\logidons\WebAPI\WebAPI\Models\DBModel.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[donArticles] (
    ...
    [quantite] int  NULL,
    [description] varchar(50)  NULL,
    [IDarticleDon] int IDENTITY(1,1) NOT NULL
);
GO
